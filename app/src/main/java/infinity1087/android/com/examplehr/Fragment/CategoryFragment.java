...
public class CategoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getData();
        Picasso.get().load("http://image.barodaweb.net/api/EGreen/Magic/270/ProductGroup-1/46bc8c078310497c981203c9ab0c5b95.jpg/100").error(R.drawable.veg).transform(new RoundedTransformation(20, 0)).into(img_btn_veggie);
        Picasso.get().load("http://image.barodaweb.net/api/EGreen/Magic/270/ProductGroup-2/3bd998d9f04c4d909953b42c461b9291.jpg/100").error(R.drawable.fruits).transform(new RoundedTransformation(20, 0)).into(img_button_fruits);
